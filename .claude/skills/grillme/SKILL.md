---
name: grillme
description: "Socratic deep-interview skill — conducts structured questioning waves (surface, clarifying, deep) to extract a complete picture on any topic instead of giving direct answers. Trigger when the user invokes /grillme, says 'grill me', 'grillame', 'ásame a preguntas', 'interrógame', 'задавай вопросы', 'допроси меня', 'интервью', 'расспроси меня', or otherwise asks to be interviewed/challenged about a decision, plan, product idea, architecture choice, or personal decision before proceeding. Do NOT use for simple factual questions or when the user just wants a direct answer."
---

# /grillme — Sократовское интервью

> Adaptado de [Jekudy/grillme-skill](https://github.com/Jekudy/grillme-skill) (MIT).
